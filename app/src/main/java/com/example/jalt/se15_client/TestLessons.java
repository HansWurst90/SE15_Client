...
public class TestLessons {
    ...
    static List<LessonTO> getLessons2(){
        ...
        lessons.add(createLesson("Chemie", 7, "Curie", 'f', 3, "A123", 8));
    ...
    static List<LessonTO> getLessons4(){
        ...
        lessons.add(createLesson("Info", 6, "Turing", 'm', 4, "A123", 17));
        lessons.add(createLesson("Spanisch", 4, "Goy Ramos", 'm', 5, "A123", 18));
    ...
    static List<LessonTO> getLessons5() {
        List<LessonTO> lessons = new ArrayList<LessonTO>();
        lessons.add(createLesson("Biologie", 8, "Darwin", 'm', 1, "A123", 20));
        lessons.add(createLesson("Mathe", 1, "Erfkämper", 'm', 2, "A123", 21));
        lessons.add(createLesson("Deutsch", 2, "Prischep", 'm', 3, "A123", 22));
        lessons.add(createLesson("Sport", 5, "Erfkämper", 'm', 4, "A123", 23));
        lessons.add(createLesson("Religion", 10, "Ratzinger", 'm', 5, "A123", 24));
        return lessons;
    }
